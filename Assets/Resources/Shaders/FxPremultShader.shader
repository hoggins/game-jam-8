	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode13 = tex2D( _MainTex, ( panner21 + ( tex2D( _DistortTex, panner31 ).r * _DistortScale ) ) );
...
{"type":"AmplifyShaderEditor.TexCoordVertexDataNode, AmplifyShaderEditor","id":24,"pos":[-1808,-128],"params":["Inherit","False","0","2","0","5","FLOAT2","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4"]}
{"type":"AmplifyShaderEditor.TextureTransformNode, AmplifyShaderEditor","id":27,"pos":[-1792,-256],"params":["Inherit","False","13","False","1","0","SAMPLER2D","","False","2","FLOAT2","0","FLOAT2","1"]}
...
{"type":"AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor","id":23,"pos":[-1584,24],"params":["Inherit","False","Property","_MainTexPanner","MainTexPanner","4","0","Create","True","0","0","0","False","0","False","Object","-1","","0,0","0,0","0","3","FLOAT2","0","FLOAT","1","FLOAT","2"]}
{"type":"AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor","id":25,"pos":[-1560,-152],"params":["Inherit","False","2","2","0","FLOAT2","0,0","False","1","FLOAT2","0,0","False","1","FLOAT2","0"]}
...
{"type":"AmplifyShaderEditor.PannerNode, AmplifyShaderEditor","id":21,"pos":[-1368,-48],"params":["Inherit","False","3","0","FLOAT2","0,0","False","2","FLOAT2","0,0","False","1","FLOAT","1","False","1","FLOAT2","0"]}
...
{"wire":[1,3,18,0]}
ASEEND*/
//CHKSM=35B7ACF0115461AA1B662DD4F2BA6CE6686DAFFC